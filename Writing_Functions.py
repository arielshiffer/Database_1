...
class WritingFunctions(DataBase):
    def __init__(self, file_name):
        ...
        :param file_name: The name we want the file to
        be called at. String.
        """
        super().__init__()
        self.file = file_name
    ...
    def read_from_file(self):
        """
        This function decrypts all the information from
        the file and puts it in the data base dictionary.
        :return: If the file exists -> return the new dictionary
        after it
        updated from the information in the file.
        Dictionary.
